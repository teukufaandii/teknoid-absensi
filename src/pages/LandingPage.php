...
<body class="bg-gray-50 flex flex-col items-center justify-center min-h-screen md:mx-0 mx-4">
    ...
    <div class="text-center">
        ...
        <div class="flex flex-col md:flex-row justify-center items-center gap-6 w-full px-4 md:px-0">
            ...
            <a href="login" class="flex flex-col items-center bg-gradient-to-r from-purple-600 to-pink-600 text-white rounded-xl px-8 py-6 shadow-lg transform hover:scale-105 transition-transform w-full">
