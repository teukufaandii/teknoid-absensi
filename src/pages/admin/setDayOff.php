...
<body>
    <div class="flex flex-col md:flex-row lg:flex-row h-screen">
        ...
        <div id="content" class="min-h-screen inline-flex flex-col flex-1 bg-mainBgColor ml-56">
            ...
            <main class="flex-1 p-6 bg-mainBgColor mainContent">
                <h1 class="text-lg sm:text-xl md:text-3xl border-b border-gray-500 py-2 font-Poppins font-semibold">Data Hari Libur</h1>
                    ...
                    <div class="relative">
                        <form method="GET">
                            <input
                                ...
                                class="w-60 px-4 py-2 border rounded-xl shadow-md focus:outline-none focus:ring-2 focus:ring-purpleNavbar" />
                ...
                <div class="tableOverflow mt-6 shadow-customTable rounded-lg">
                    <table class="min-w-full bg-white border" id="tableHolidays">
                        <thead>
                        ...
                        <tbody id="holiday-table-body" class="divide-y divide-gray-200">
                        </tbody>
                    </table>
                </div>
    ...
    <script src="src/pages/admin/js/renderDataHoliday.js"></script>
</body>
