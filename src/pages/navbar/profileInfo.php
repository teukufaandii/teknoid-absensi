...
?>
        ...
        <div id="profileMenu" class="profile-menu right-0 top-14 z-[999999]">
            ...
            <a href="setting" class="menu-item block text-center border-t hover:bg-gray-100 p-2 text-sm">
                <i class="fa-solid fa-gear"></i> Pengaturan Akun
            </a>
            <a href="api/auth/logout" class="text-red-400 menu-item block text-center border-t hover:bg-gray-100 rounded-b-md p-2 text-sm ">
